...
int main() {
	...
	world.add(std::make_shared<sphere>(point3( 0.5, 0,     -2),   0.5,    material_right));
	world.add(std::make_shared<sphere>(point3( 0.0, 0,     -0),   0.5,    material_center));
	world.add(std::make_shared<sphere>(point3(-0.5, 0,     -2),   0.5,    material_left));
...
//	world.add(std::make_shared<sphere>(point3( 0.0, 0,      1), 0.5,    material_center));
